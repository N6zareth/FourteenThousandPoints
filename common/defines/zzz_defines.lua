...
NDefines.NDiplomacy.UNCONDITIONAL_SURRENDER_MIN_MONTHS = 1 -- Basically, once you occupy all of the provinces & kill all of the ai's armies u get 100% warscore
...
NDefines.NMilitary.MERCENARY_REINFORCE_COST_MULTIPLIER = 5
...
NDefines.NMilitary.TRANSPORT_TIME = 15
NDefines.NMilitary.TRANSPORT_MAINT_FACTOR = 0 
...
NDefines.NCountry.PS_RAISE_TARIFFS = 777
...
NDefines.NNationDesigner.POINTS_AVAILABLE = 9999
